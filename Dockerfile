...
FROM postgres:17-alpine AS pg12-builder
FROM postgres:17-alpine AS pg13-builder
FROM postgres:17-alpine AS pg14-builder
FROM postgres:17-alpine AS pg15-builder
FROM postgres:17-alpine AS pg16-builder
